...
contract Voting is Ownable {
    ...
    function addCandidate(
        ...
        elections[_electionId].candidates[candidateId].id = candidateId;
        elections[_electionId].candidates[candidateId].name = _name;
        elections[_electionId].candidates[candidateId].voteCount = 0;
    ...
    function vote(
        ...
        require(_candidateId <= elections[_electionId].candidatesCount, "Invalid candidate");
    ...
    function hasUserVoted(uint256 _electionId) external view returns (bool) {
